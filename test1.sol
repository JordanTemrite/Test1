...
contract StakeHubToken is ERC20, Ownable {
    ...
    mapping(uint256 => mapping (address => UserInfo)) userStakeId;
    
    mapping(address => uint256) internal userPairStakes; 
    ...
    function createStake(address _staker, address _stakingPair, uint256 _stake)
    public
    {
        _stake = _stake * 1e18;
